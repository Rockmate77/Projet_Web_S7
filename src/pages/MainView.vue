...
:root {
  --top-bar-height: 10%;
  --middle-section-height: 50%;
  --bottom-section-height: 40%;
  --pane-border: 2px solid black;
...
@media (max-width: 600px) {
  ...
  .middle-section, .bottom-section {
    flex-direction: column; /* Changez la disposition horizontale par défaut en une disposition verticale */
  }

  .left-pane, .center-pane, .right-pane, .left-bottom-pane, .right-bottom-pane {
    width: 100%; /* Les éléments prennent toute la largeur de l'écran */
    border-left: none;  /* Retirer les bordures gauches */
    border-right: none;  /* Retirer les bordures droites */
  }
